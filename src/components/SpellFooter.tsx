...
const SpellFooter = ({ spell }: { spell: Spell }) => {
  return (
    <section
      className={` absolute bottom-0  grid  w-full  grid-cols-3 justify-center rounded-b-lg pt-4 text-zinc-900  ${
    ...
    >
      ...
      {spell.S || spell.M || spell.V ? (
        <section
          className={
            " col-start-3 m-auto  min-h-[50px] min-w-full self-center font-bold"
          }
        >
