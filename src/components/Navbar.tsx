...
const NavBar: NextPage = () => {
  ...
  return (
    <nav>
      <ul className=" mobile-nav flex  w-full justify-end gap-10 border-b-2 border-solid border-black bg-zinc-900 p-4 text-xs text-white md:gap-48 md:pr-16 md:text-base lg:text-lg">
        <li>
          <Link role="link" className={liClass} href="/classes">
            Classes
          </Link>
        </li>
        <li>
